<div class="row-fluid">
	...
	<div class="span10">
		<div class="btn-group pull-right">
			<?php echo $this->Html->link('Edit', array('action' => 'edit', $psa['PSAEvent']['e_Id']), array('class' => 'btn')); ?>
		</div>
		<h1><?php echo $psa['PSAEvent']['e_Title'] ?></h1>
		<h2><small><i><?php echo isset($psa['PSACategory']['Title']) ? $psa['PSACategory']['Title'] : 'No Category Set' ?></i></small></h2>
		<div class="well"><?php echo $psa['PSAEvent']['e_Copy'] ?></div>
	</div>
</div>
