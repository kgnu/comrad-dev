<div class="row-fluid">
	...
	<div class="span10">
		<div class="btn-group pull-right">
			<?php echo $this->Html->link('Edit', array('action' => 'edit', $underwriting['UnderwritingEvent']['e_Id']), array('class' => 'btn')); ?>
		</div>
		<h1><?php echo $underwriting['UnderwritingEvent']['e_Title'] ?></h1>
		<div class="well"><?php echo $underwriting['UnderwritingEvent']['e_Copy'] ?></div>
	</div>
</div>
