<div class="row-fluid">
	...
	<div class="span10">
		<table class="table table-condensed">
			...
			<tbody>
				<?php foreach($easTests as $easTest): ?>
					<tr>
						<td><?php echo $this->Html->link($easTest['EASTestEvent']['e_Title'], array('controller' => 'e_a_s_tests', 'action' => 'view', $easTest['EASTestEvent']['e_Id'])); ?></td>
						<td><?php echo $easTest['EASTestEvent']['e_Active'] ?></td>
						<td style="white-space: nowrap">
							<div class="btn-group pull-right">
								<?php echo $this->Html->link($this->TB->icon('pencil'), array('controller' => 'e_a_s_tests', 'action' => 'edit', $easTest['EASTestEvent']['e_Id']), array('class' => 'btn btn-mini', 'escape' => false)); ?>
							</div>
						</td>
					</tr>
				<?php endforeach; ?>
		...
		<?php echo $this->Html->link('<i class="icon-plus"></i> Add EAS Test', array('action' => 'add'), array('class' => 'btn', 'escape' => false)); ?>
	</div>
</div>
