<div class="row-fluid">
	...
	<div class="span10">
		<div class="btn-group pull-right">
			<?php echo $this->Html->link('Edit', array('action' => 'edit', $alert['AlertEvent']['e_Id']), array('class' => 'btn')); ?>
		</div>
		<h1><?php echo $alert['AlertEvent']['e_Title'] ?></h1>
		<div class="well"><?php echo $alert['AlertEvent']['e_Copy'] ?></div>
	</div>
</div>
