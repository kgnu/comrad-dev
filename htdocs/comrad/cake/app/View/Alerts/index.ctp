<div class="row-fluid">
	...
	<div class="span10">
		<table class="table table-condensed">
			...
			<tbody>
				<?php foreach($alerts as $alert): ?>
					<tr>
						<td><?php echo $this->Html->link($alert['AlertEvent']['e_Title'], array('controller' => 'alerts', 'action' => 'view', $alert['AlertEvent']['e_Id'])); ?></td>
						<td><?php echo $alert['AlertEvent']['e_Active'] ?></td>
						<td style="white-space: nowrap">
							<div class="btn-group pull-right">
								<?php echo $this->Html->link($this->TB->icon('pencil'), array('controller' => 'alerts', 'action' => 'edit', $alert['AlertEvent']['e_Id']), array('class' => 'btn btn-mini', 'escape' => false)); ?>
							</div>
						</td>
					</tr>
				<?php endforeach; ?>
		...
		<?php echo $this->Html->link('<i class="icon-plus"></i> Add Alert', array('action' => 'add'), array('class' => 'btn', 'escape' => false)); ?>
	</div>
</div>
