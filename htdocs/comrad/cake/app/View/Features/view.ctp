<div class="row-fluid">
	...
	<div class="span10">
		<div class="btn-group pull-right">
			<?php echo $this->Html->link('Edit', array('action' => 'edit', $feature['FeatureEvent']['e_Id']), array('class' => 'btn')); ?>
		</div>
		<h1><?php echo $feature['FeatureEvent']['e_Title'] ?></h1>
		<div class="well"><?php echo $feature['FeatureEvent']['e_Description'] ?></div>
	</div>
</div>
