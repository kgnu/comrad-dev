<div class="row-fluid">
	...
	<div class="span10">
		<table class="table table-condensed">
			...
			<tbody>
				<?php foreach($announcements as $announcement): ?>
					<tr>
						<td><?php echo $this->Html->link($announcement['AnnouncementEvent']['e_Title'], array('controller' => 'announcements', 'action' => 'view', $announcement['AnnouncementEvent']['e_Id'])); ?></td>
						<td><?php echo $announcement['AnnouncementEvent']['e_Active'] ?></td>
						<td style="white-space: nowrap">
							<div class="btn-group pull-right">
								<?php echo $this->Html->link($this->TB->icon('pencil'), array('controller' => 'announcements', 'action' => 'edit', $announcement['AnnouncementEvent']['e_Id']), array('class' => 'btn btn-mini', 'escape' => false)); ?>
							</div>
						</td>
					</tr>
				<?php endforeach; ?>
		...
		<?php echo $this->Html->link('<i class="icon-plus"></i> Add Announcement', array('action' => 'add'), array('class' => 'btn', 'escape' => false)); ?>
	</div>
</div>
