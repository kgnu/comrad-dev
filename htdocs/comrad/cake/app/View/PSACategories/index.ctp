<div class="row-fluid">
	...
	<div class="span10">
		<table class="table table-condensed">
			...
			<tbody>
				<?php foreach($psaCategories as $psaCategory): ?>
					<tr>
						<td><?php echo $this->Html->link($psaCategory['PSACategory']['Title'], array('controller' => 'p_s_a_categories', 'action' => 'view', $psaCategory['PSACategory']['Id'])); ?></td>
						<td style="white-space: nowrap">
							<div class="btn-group pull-right">
								<?php echo $this->Html->link($this->TB->icon('pencil'), array('controller' => 'p_s_a_categories', 'action' => 'edit', $psaCategory['PSACategory']['Id']), array('class' => 'btn btn-mini', 'escape' => false)); ?>
							</div>
						</td>
					</tr>
				<?php endforeach; ?>
		...
		<?php echo $this->Html->link('<i class="icon-plus"></i> Add PSA Category', array('action' => 'add'), array('class' => 'btn', 'escape' => false)); ?>
	</div>
</div>
