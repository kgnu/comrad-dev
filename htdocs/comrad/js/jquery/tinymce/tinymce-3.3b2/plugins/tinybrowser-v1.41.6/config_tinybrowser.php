...
$tinybrowser['obfuscate'] = 'B@nan@J|_|ngle%^dsf213';
...
$tinybrowser['path']['image'] = '/publicfiles/tiny/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/publicfiles/tiny/media/'; // Media files location
$tinybrowser['path']['file']  = '/publicfiles/tiny/files/'; // Other files location
