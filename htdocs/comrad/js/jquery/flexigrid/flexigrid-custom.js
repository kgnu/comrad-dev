...
(function($){
	...
	$.addFlex = function(t,p)
	{
		...
		p = $.extend({
			 ...
			 onSelect: false, // no callback when selecting table elements
			 onDeselect: false // no callback when deselecting table elements
		  }, p);
							...
							.click(
								function (e) 
									{ 
										...
										if (p.onSelect && $(this).hasClass('trSelected')) p.onSelect($(this));
										if (p.onDeselect && !$(this).hasClass('trSelected')) p.onDeselect($(this));
									}
							)
							.mousedown(
								function (e) {}
